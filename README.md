...
**AI ASSISTANCE USED IN Building the Bridge.py and runaerodynamicpipeline()(in UAV FRontend.html): were used to help scaffold the glue layer connecting the two — the Python bridge server and the JS data-fetching pipeline**
